...
Node *interleave(Node *list1, Node *list2)
{
   ...
   if(list1 == NULL){
    Node* newNode = new Node(list2->key, interleave(list1, list2->next));
    return newNode;
   }
   if(list2 == NULL){
    Node* newNode = new Node(list1->key, interleave(list1->next, list2));
    return newNode;
   }
   ...
   newNode->next = new Node(list2->key, interleave(list1->next, list2->next));
